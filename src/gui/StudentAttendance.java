...
public class StudentAttendance extends javax.swing.JFrame {
    ...
    public void comb()
    {
        try
        {
            ...
            while(rs.next())
            {
                jComboBox2.addItem(rs.getString("rollno"));
            }
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(467, 499));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            DBConnection db=new DBConnection();
            String sql="insert into attendance_student values('"+jComboBox2.getSelectedItem().toString()+"','"+date+"','"+jComboBox1.getSelectedItem().toString()+"','"+jComboBox3.getSelectedItem().toString()+"')";
