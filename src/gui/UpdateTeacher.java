...
public class UpdateTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Enter employee id to search data of teacher");
        ...
        setSize(new java.awt.Dimension(968, 713));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String q="update teacher set name='"+name+"',employeeid='"+employeeid+"',email='"+email+"',dob='"+dob+"',contact='"+contact+"',education='"+education+"',department='"+department+"',gender='"+gender+"',graduation='"+graduation+"',address='"+address+"'where employeeid='"+jTextField9.getText()+"'";
            db.s.executeUpdate(q);
            JOptionPane.showMessageDialog(this, "Teacher Details Updated Succesfully!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try
        {
            ...
            String sql="select * from teacher where employeeid='"+emp+"'";
            ...
            while(rs.next())
            {
                ...
                jTextField10.setText(rs.getString("education"));
                ...
                jTextField5.setText(rs.getString("graduation"));
