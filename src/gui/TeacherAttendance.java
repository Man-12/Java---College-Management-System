...
public class TeacherAttendance extends javax.swing.JFrame {
    ...
    public void comb()
    {
        try
        {
            ...
            ResultSet rs=db.s.executeQuery("select * from teacher");
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Present", "Absent", "Leave" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            DBConnection db=new DBConnection();
            String sql="insert into attendance_teacher values('"+jComboBox2.getSelectedItem().toString()+"','"+date+"','"+jComboBox1.getSelectedItem().toString()+"','"+jComboBox3.getSelectedItem().toString()+"')";
